...
const getFileName: (inconFileInfo: IAddIconRequestData) => string
 ...
 */
const createIconFile: (inconFileInfo: IAddIconRequestData, iconRepository: string) => Observable<string>
...
const createAddIconFileJob: (
    inconFileInfo: IAddIconRequestData,
    userName: string,
